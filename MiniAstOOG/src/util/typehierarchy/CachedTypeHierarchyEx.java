...
import edu.cmu.cs.crystal.util.typehierarchy.TypeNode;

/**
 * 
 * HACK: This is a copy of CachedTypeHierarchy. 
 * TODO:LOW. Merge with CachedTypeHierarchy
 * 
 * 
 * */
public class CachedTypeHierarchyEx implements TypeHierarchy {
	...
	public CachedTypeHierarchyEx(IJavaProject project) throws JavaModelException {
	...
	private boolean isSubtypeCompatibleGenerics(String listSub, String listSuper) {
		...
		if (listSub.equals(""))
			return false;
		if (!listSub.equals(listSuper)) return false;
//CUT: if the lists are not equals the generics are not compatible
