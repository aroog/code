...
public class ArchitecturalDecoratingLabelProvider extends DecoratingLabelProvider implements IColorProvider,
        IFontProvider {
	public ArchitecturalDecoratingLabelProvider() {
		super(new LabelProviderObjectGraph(null), new ArchitecturalLabelDecorator());
