...
public class InferOptions {
	...
	private boolean turnOFFLent = false;
	
	private boolean turnOFFUnique = false;
	
	private boolean oogreAuto = false;
	...
	public boolean isTurnOFFLent() {
		return turnOFFLent;
	}

	public void setTurnOFFLent(boolean turnOFFLent) {
    	this.turnOFFLent = turnOFFLent;
    }
	
	public boolean isTurnOFFUnique() {
		return turnOFFUnique;
	}

	public void setTurnOFFUnique(boolean turnOFFUnique) {
    	this.turnOFFUnique = turnOFFUnique;
    }
	
	public boolean isAutoOOGRE() {
		return oogreAuto;
	}

	public void setOOGREAuto(boolean oogreAuto) {
    	this.oogreAuto = oogreAuto;
    }
}
