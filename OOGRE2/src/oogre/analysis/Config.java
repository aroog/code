...
public class Config {
	...
	public static void loadConfig(IPath path) {
		try {
			...
			String property8 = props.getProperty("turnOFFLent");
			InferOptions.getInstance().setTurnOFFLent(property8 != null && property8.equals("true"));
			
			String property9 = props.getProperty("turnOFFUnique");
			InferOptions.getInstance().setTurnOFFUnique(property9 != null && property9.equals("true"));
			
			String property10 = props.getProperty("OOGREAuto");
			InferOptions.getInstance().setOOGREAuto(property10 != null && property10.equals("true"));
		} 
