...
public class OOGContext {
	...
	private List<Refinement> completedRefs = new ArrayList<Refinement>();
	
	private List<Heuristic> completedHeus = new ArrayList<Heuristic>();
	...
	public List<Refinement> getCompletedRefinements() {
		return completedRefs;
	}
	
	public boolean addCompletedRefinement(Refinement ref) {
		return completedRefs.add(ref);
	}
	
	public List<Heuristic> getCompletedHeuristics() {
		return completedHeus;
	}
	
	public boolean addCompletedHeuristic(Heuristic heu) {
		return completedHeus.add(heu);
	}
