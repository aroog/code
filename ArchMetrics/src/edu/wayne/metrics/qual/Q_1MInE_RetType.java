...
import edu.wayne.metrics.adb.HowManyEdgesToMethodInvok_RetType.HowManyEdges_MIRetType;
import edu.wayne.metrics.utils.CSVConst;
import edu.wayne.metrics.utils.CSVOutputUtils;
import edu.wayne.ograph.ODFEdge;

public class Q_1MInE_RetType extends Q_Base {
	...
	public Q_1MInE_RetType(Writer writer, Set<EdgeInfo> outliers, String shortMetricName) {
		this.writer = writer;
	...
	public void visit() {
		...
		for (EdgeInfo edgeInfo : outliers) {
			if (edgeInfo instanceof HowManyEdges_MIRetType) {
				HowManyEdges_MIRetType MI_edgeInfo = (HowManyEdges_MIRetType) edgeInfo;
